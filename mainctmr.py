...
target_train_pth = './datactmr/datalist/training_A.txt'
source_val_pth = './datactmr/datalist/validation_B.txt'
target_val_pth = './datactmr/datalist/validation_A.txt'
        ...
        with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
            ...
            for epoch in range(sess.run(self.global_step), self._max_step):
                ...
                for i in range(0, max_inter):
                    ...
                    #if (cnt+1) % 20 ==0:
                        #print('GAN:',self.lr_gan_summ,'Seg:',self.lr_seg_summ)
